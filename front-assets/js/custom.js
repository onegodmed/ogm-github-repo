...
// 	var counter = 0;
	...
	$('.menu-btn').on("click", function(){
		...
		if(menuBtn.attr('src').indexOf('menu.png') > -1) {
			...
			menuBtn.attr('src', BASE_URL+'front-assets/images/header/close.png');
		} else {
			$('.sidebar-new').removeClass('show');
			$('.menu-box').removeClass('show')
			menuBtn.attr('src', BASE_URL+'front-assets/images/header/menu.png');
		}
	...
	$(document).mouseup(function(e) 
	{
		...
		var container = $(".header .wrapper .menu-box.show ul.menu-items li.menu-item a,.menu-btn");
	...
	function fout() {
		$('#notifySucess').fadeOut(1000);
	   }
	  

	$('.askastro .callbtn .follow.btn-style1').click(function(){
			$('#notifySucess').fadeIn(1000);
	...
	if($(window).width() <= 550) {
		$('#carousel-banner-1').attr('src', BASE_URL+'front-assets/images/banner-1-sm.jpg');
		$('#carousel-banner-2').attr('src', BASE_URL+'front-assets/images/banner-2-sm.jpg');
		$('#carousel-banner-3').attr('src', BASE_URL+'front-assets/images/banner-3-sm.jpg');
	}



	$(".searchastro ").click(function(){
		$(this).addClass("clicked");

	});
	$(".showmobiledevice").click(function(){

		$(".searchastro ").removeClass("clicked")
	})
	...
	$(window).scroll(function(){
		var window_top = $(window).scrollTop() + 1;
		if (window_top >50) {
			$('.ast_header_bottom').addClass('sidebardown');
		} else {
			$('.ast_header_bottom').removeClass('sidebardown');
		}
	});
	...
	//Product carousel
		...
		// 	related productSub
			...
			// 	var classExist=$(".dropdown-menu.collapse").hasClass("in")

			// 	if(classExist==true){
			// 		$(".dropdown-menu.collapse").removeClass("in");

			// 	}
				
			// });
			
		$("#chat .input-group-append").click(function(){
			$('#chtcntr').stop().animate({
				scrollTop: $('#chtcntr')[0].scrollHeight
			  }, 800);
...
$( '.dropdown-menu.fliterwala a' ).on( 'click', function( event ) {
