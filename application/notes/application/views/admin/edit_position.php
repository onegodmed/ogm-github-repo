        ...
        <div class="container form-one">
                    <div class="card">
                      <div class="card-header">
                        ...
                        <form action="<?= base_url('admin/update_position')?>" method="POST" class="form-horizontal">
                      <div class="card-body card-block">
                        
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Position</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="hf-email" name="position" placeholder="Enter Position..." class="form-control" value="<?php echo $position[0]->position_name?>"></div>
                            <input type="hidden" name="id"  value="<?= $position[0]->id ?>">
                          </div>
                            </div>
