                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">All Tools</strong>
                        </div>                       
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->name ?></td>
                             <td> <div class="btn-group">
                                     ...
                                     <a  title="delete" href="<?= base_url('admin/delete_tools/' . $row->id ) ?>" onclick="return confirm('Are you sure you want to delete?');"  class="btn btn-xs btn-default " ><i class="fa fa-times"></i></a>
