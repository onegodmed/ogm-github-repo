...
<div class="container form-one">
    <div class="card">
        ...
        <form action="<?= base_url('admin/add_category') ?>" method="POST" class="form-horizontal">
            <div class="card-body card-block">

                <div class="row form-group">
                    <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Category</label></div>
                    <div class="col-12 col-md-9"><input type="text" id="hf-email" name="category" placeholder="Enter Category..." class="form-control"></div>
                </div>
            </div>
