        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row"><div class="col-md-3 ">
                            <a href="<?= base_url('admin/skills');?>" class="btn btn-success waves-effect waves-light m-r-10">Add Skill</a>
                        </div></div><br/>
                <div class="row">
                <div class="col-md-12">
                    <div class="card">
                  ...
                  <table id="listTable" class="table table-striped table-bordered">
                    <thead>
                      ...
                      <input type="checkbox" name="check_all" id="check_all" value=""/><span></span>
                        ...
                        <th style="width: 84px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions">Add MCQ</th>

                        <th style="width: 84px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions">Upload More</th>
                      ...
                      <tr id="911" role="row" class="odd">
                        ...
                        <td><?php echo $row->subject_name;?></td>
                         <td><?php echo $row->chapter_name;?></td>
                          ...
                          <td><a href="<?php echo base_url('admin/upload_more/'.$row->id);?>">Upload More</a></td>
                          <td> 
                          <div class="btn-group">
                              <a title="edit"  href="<?= base_url('admin/edit_product/' . $row->id ) ?>" class="btn btn-xs btn-default"> <i class="fa fa-pencil"></i></a>
