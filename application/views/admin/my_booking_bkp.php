                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                         ...
                         <!--           <table id="zero_config1"  class="table table-striped table-bordered display">-->
                         ...
                         <!--                           </td>-->
                         <!--                              <td>-->
                         <!--                                  <?php if($row->is_Active == 'Accept'){?>-->
                                                           
                                        
                                                                       
                         <!--                                                   <a class="btn btn-primary" href="<?php echo base_url('admin/video_call/'.$row->id)?>">Start Call</a>-->
                         ...
                         <!--  <?php //if ($row->is_Active == "Running" OR $row->is_Active == "") {  ?> -->

                       
                         <!--                                                   <a href="<?php echo base_url('admin/update_status/Accept/'.$row->id.'/'.$row->customer_id)?>" class="btn btn-primary">Accept</a>-->

                         <!--                                                   <a href="<?php echo base_url('admin/update_status/Reject/'.$row->id.'/'.$row->customer_id)?>" class="btn btn-danger">Reject</a>-->

                         <!--                                                   <?php // }else{?>-->

                         <!--                                                       <a href="<?php echo base_url('admin/update_status/Complete/'.$row->id.'/'.$row->customer_id)?>" class="btn btn-primary">Complete</a>-->
                         ...
                         <!--                           <?php if($row->call_type == 'Audio'){?>-->

                         <!--                               <td>-->
                         <!--                                   <button class="btn btn-primary">Audio</button>-->
                         <!--                               </td>-->

                         <!--                               <?php }elseif($row->call_type == 'Video'){ ?>-->
                         ...
                         <!--       <h3>Pooja(Online /Offline)</h3>-->

                         <!--       <div class="table-responsive">-->
                         <!--           <button class="button-exce" id="button-excel4">Create Excel</button>-->
