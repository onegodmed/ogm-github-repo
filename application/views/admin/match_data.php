            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Match Making Data</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Match Making Data</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display nowrap table table-striped table-bordered" style="width:100%">
                                        ...
                                        <th>Boy Name</th>
                                        <th>Boy DOB</th>
                                        <th>Boy Birth Place</th>
                                        <th>Phone</th>
                                        <th>Email</th>
                                        <th>Girl Name</th>
                                        <th>Girl DOB</th>
                                        <th>Girl Birth Place</th>
                                        <th>Date & Time</th>
                                    </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <td><?php $m_dob = date('d-m-Y', strtotime($row->m_dob)); echo $m_dob;?></td>
                                        <td><?php echo $row->m_place?></td>
                                        <td><?php echo $row->mobile?></td>
                                        <td><?php echo $row->email?></td>
                                        <td><?php echo $row->f_name?></td>
                                        <td><?php $fdob = date('d-m-Y', strtotime($row->f_dob)); echo $fdob;?></td>
