...
<head>
    ...
    <title>Partner Login | Onegodmed </title>
    <meta content="Partner Dashboard" name="description">
    <meta content="Onegodmed" name="author">
        ...
        <div class="card">
            <div class="card-body">
                <div class="p-3">
                    ...
                    <p class="text-muted text-center">Sign in to continue to Partner.</p>
                    <form class="form-horizontal m-t-30" method="POST" action="<?php echo base_url('adminlogin/login_code')?>">
                        <p style="color: red"><?php echo $this->session->flashdata('error')?></p>
                        <div class="form-group">
                            <label for="username">Username</label>
                            <input type="hidden" class="form-control" id="utype" name="utype" value="vendor">
                        ...
                        <div class="form-group m-t-10 mb-0 row">
                            ...
                            <button class="btn btn-primary w-md waves-effect waves-light" type="submit" style="width:100%;height:42px;font-size:16px">Log In</button>
                                </div>
                        </div>
                    </form>
                </div>
