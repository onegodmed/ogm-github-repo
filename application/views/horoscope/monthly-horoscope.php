	...
	<div class="container">
		<div class="row">
		    	<div class="ast_heading">
					...
					<h1><?php echo ucfirst(@$horodata['sun_sign']).' '.ucfirst($this->uri->segment(3)); ?> Horoscope <small> ( 
            ...
            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
				...
				<!--	<ul class="nav nav-tabs horoscopcent">
					...
					<div class="tab-content">
						...
						<div class="row">
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/aries/"><img src="<?= base_url()?>front-assets/images/header/Aries.png" class="img-responsive"><span class="rajshree">ARIES</span><br />21/3 - 19/4</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/taurus/"><img src="<?= base_url()?>front-assets/images/header/Taurus.png" class="img-responsive"><span class="rajshree">TAURUS</span><br />20/4 - 20/5</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/gemini/"><img src="<?= base_url()?>front-assets/images/header/Gemini.png" class="img-responsive"><span class="rajshree">GEMINI</span><br />21/5 - 20/6</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/cancer/"><img src="<?= base_url()?>front-assets/images/header/Cancer.png" class="img-responsive"><span class="rajshree">CANCER</span><br />21/6 - 22/7</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/leo/"><img src="<?= base_url()?>front-assets/images/header/Leo.png" class="img-responsive"><span class="rajshree">LEO</span><br />23/7 - 22/8</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/virgo/"><img src="<?= base_url()?>front-assets/images/header/Virgo.png" class="img-responsive"><span class="rajshree">VIRGO</span><br />23/8 - 22/9</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/libra/"><img src="<?= base_url()?>front-assets/images/header/Libra.png" class="img-responsive"><span class="rajshree">LIBRA</span><br />23/9 - 22/10</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/scorpio/"><img src="<?= base_url()?>front-assets/images/header/Scorpio.png" class="img-responsive"><span class="rajshree">SCORPIO</span><br />23/10 - 21/11</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/sagittarius/"><img src="<?= base_url()?>front-assets/images/header/Sagittarius.png" class="img-responsive"><span class="rajshree">SAGITTARIUS</span><br />22/11 - 21/12</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/capricorn/"><img src="<?= base_url()?>front-assets/images/header/Capricorn.png" class="img-responsive"><span class="rajshree">CAPRICORN</span><br />22/12 - 19/1</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/aquarius/"><img src="<?= base_url()?>front-assets/images/header/Aquarius.png" class="img-responsive"><span class="rajshree">AQUARIUS</span><br />20/1 - 18/2</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/monthly/pisces/"><img src="<?= base_url()?>front-assets/images/header/Pisces.png" class="img-responsive"><span class="rajshree">PISCES</span><br />19/2 - 20/3</a></div>
</div>			
						</div>
					...
					<div class="tab-content">
						<div class="tab-pane" id="tab_default_02">
						   ...
						   <div class="col-md-1"><a href="#"><img src="<?= base_url()?>front-assets/images/header/<?php echo ucfirst(@$horodata['sun_sign']);?>.png" class="img-responsive"><span class="rajshree"><?php echo ucfirst(@$horodata['sun_sign']);?></span></a></div>
							...
							<div class="tab-pane active" id="tab_default_05">
							<div class"row">
						    	<div class"col-md-4">
						   <div class="col-md-1"><a href="#"><img src="<?= base_url()?>front-assets/images/header/<?php echo ucfirst(@$horodata['sun_sign']);?>.png" class="img-responsive"><span class="rajshree"><?php echo ucfirst(@$horodata['sun_sign']);?></span></a></div>
						</div>
							<div class"col-md-8 " style="text-align: justify; display: table; font-size:15px; line-height:1.8;">
						    <p class"sinl"><?php foreach($horodata['prediction'] as $value){ echo $value.' ';}?></p>
						    <a href="<?= base_url()?>talk-to-astrologers/">Click here for a more personalised reading</a>
...
<!--					<h1><?php echo ucfirst($this->uri->segment(3));?> planetary movements</h1>-->
...
<!--			<h4 class="list-group-item-heading"><?php echo ucfirst(@$horodata['sun_sign']).' '.$this->uri->segment(3);?> Love Horoscope</h4> -->
...
<!--			<h4 class="list-group-item-heading"><?php echo ucfirst(@$horodata['sun_sign']).' '.$this->uri->segment(3);?> Career Horoscope</h4> -->
...
<!--			<h4 class="list-group-item-heading"><?php echo ucfirst(@$horodata['sun_sign']).' '.$this->uri->segment(3);?> Finance Horoscope</h4> -->
...
<!--			<h4 class="list-group-item-heading"><?php echo ucfirst(@$horodata['sun_sign']).' '.$this->uri->segment(3);?> Health Horoscope</h4> -->
