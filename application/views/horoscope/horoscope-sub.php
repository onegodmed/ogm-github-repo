...
<!--BKnowcrumb start-->
<div class="ast_whywe_wrapper ast_toppadder70 ast_bottompadder70" style="padding-bottom: 10px !important;">

	<div class="container">
		<div class="row">
		    	<div class="ast_heading">

					<h1><?php echo $horodata[0]->rashi_name.' '.' '.$this->uri->segment(3).' '.$this->uri->segment(5); ?> Horoscope</h1>
            ...
            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
				...
				<!--	<ul class="nav nav-tabs horoscopcent">
					...
					<div class="tab-content">
						...
						<div class="row">
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/aries/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Aries.png" class="img-responsive"><span class="rajshree">ARIES</span><br />21/3 - 19/4</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/taurus/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Taurus.png" class="img-responsive"><span class="rajshree">TAURUS</span><br />20/4 - 20/5</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/gemini/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Gemini.png" class="img-responsive"><span class="rajshree">GEMINI</span><br />21/5 - 20/6</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/cancer/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Cancer.png" class="img-responsive"><span class="rajshree">CANCER</span><br />21/6 - 22/7</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/leo/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Leo.png" class="img-responsive"><span class="rajshree">LEO</span><br />23/7 - 22/8</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/virgo/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Virgo.png" class="img-responsive"><span class="rajshree">VIRGO</span><br />23/8 - 22/9</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/libra/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Libra.png" class="img-responsive"><span class="rajshree">LIBRA</span><br />23/9 - 22/10</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/scorpio/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Scorpio.png" class="img-responsive"><span class="rajshree">SCORPIO</span><br />23/10 - 21/11</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/sagittarius/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Sagittarius.png" class="img-responsive"><span class="rajshree">SAGITTARIUS</span><br />22/11 - 21/12</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/capricorn/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Capricorn.png" class="img-responsive"><span class="rajshree">CAPRICORN</span><br />22/12 - 19/1</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/aquarius/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Aquarius.png" class="img-responsive"><span class="rajshree">AQUARIUS</span><br />20/1 - 18/2</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/daily/pisces/<?php echo $this->uri->segment(5);?>/"><img src="<?= base_url()?>front-assets/images/header/Pisces.png" class="img-responsive"><span class="rajshree">PISCES</span><br />19/2 - 20/3</a></div>
</div>			
						</div>
...
<!--BKnowcrumb start-->
<div class="ast_whywe_wrapper ast_toppadder70 ast_bottompadder70" style="padding-top: 10px !important;">
					...
					<div class="tab-content">
						   ...
						   <div class="col-md-1"><a href="#"><img src="<?= base_url()?>front-assets/images/header/<?php echo $horodata[0]->rashi_name;?>.png" class="img-responsive"><span class="rajshree"><?php echo $horodata[0]->rashi_name;?></span></a></div>
							...
							<div class"col-md-8" style="text-align: justify; display: table; font-size:15px; line-height:1.8;">
						     <p class"sinl"><?php if($this->uri->segment(5)=="love"){
						     echo $horodata[0]->love_horoscope;
						     } else if($this->uri->segment(5)=="career"){
						     echo $horodata[0]->career_horoscope;
						     } else if($this->uri->segment(5)=="finance"){
						     echo $horodata[0]->finance_horoscope;
						     } else if($this->uri->segment(5)=="health"){
						     echo $horodata[0]->health_horoscope;
						     } else if($this->uri->segment(5)=="personality"){
						     echo $horodata[0]->personality_desc;
						     } else if($this->uri->segment(5)=="lover"){
						     echo $horodata[0]->lover_desc;
						     } else if($this->uri->segment(5)=="professional"){
						     echo $horodata[0]->professional_desc;
						     } else if($this->uri->segment(5)=="teen"){
						     echo $horodata[0]->teen_desc;
						     }?></p>
						    <a href="<?= base_url()?>consult-now">Click here for a more personalised reading</a>
