...
var week_url = host + '/horoscopes/'  + pathArray[2] + '/weekly/' + pathArray[4] + '/';
...
$(document).ready(function(){
  ...
  $("#weeksegment").click(function(){
   window.location.href = week_url;
  });
  $("#monthlysegment").click(function(){
   window.location.href = month_url;
  });
  $("#nextyearsegment").click(function(){
      $("#nextyeardata").css("display","block");
      $("#currentyeardata").css("display","none");
  });
  $("#currentyearsegment").click(function(){
      $("#currentyeardata").css("display","block");
      $("#nextyeardata").css("display","none");
  });
});
</script>
            ...
            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
				...
				<!--	<ul class="nav nav-tabs horoscopcent">
					...
					<div class="tab-content">
						...
						<div class="row">
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/aries/"><img src="<?= base_url()?>front-assets/images/header/Aries.png" class="img-responsive"><span class="rajshree">ARIES</span><br />21/3 - 19/4</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/taurus/"><img src="<?= base_url()?>front-assets/images/header/Taurus.png" class="img-responsive"><span class="rajshree">TAURUS</span><br />20/4 - 20/5</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/gemini/"><img src="<?= base_url()?>front-assets/images/header/Gemini.png" class="img-responsive"><span class="rajshree">GEMINI</span><br />21/5 - 20/6</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/cancer/"><img src="<?= base_url()?>front-assets/images/header/Cancer.png" class="img-responsive"><span class="rajshree">CANCER</span><br />21/6 - 22/7</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/leo/"><img src="<?= base_url()?>front-assets/images/header/Leo.png" class="img-responsive"><span class="rajshree">LEO</span><br />23/7 - 22/8</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/virgo/"><img src="<?= base_url()?>front-assets/images/header/Virgo.png" class="img-responsive"><span class="rajshree">VIRGO</span><br />23/8 - 22/9</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/libra/"><img src="<?= base_url()?>front-assets/images/header/Libra.png" class="img-responsive"><span class="rajshree">LIBRA</span><br />23/9 - 22/10</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/scorpio/"><img src="<?= base_url()?>front-assets/images/header/Scorpio.png" class="img-responsive"><span class="rajshree">SCORPIO</span><br />23/10 - 21/11</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/sagittarius/"><img src="<?= base_url()?>front-assets/images/header/Sagittarius.png" class="img-responsive"><span class="rajshree">SAGITTARIUS</span><br />22/11 - 21/12</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/capricorn/"><img src="<?= base_url()?>front-assets/images/header/Capricorn.png" class="img-responsive"><span class="rajshree">CAPRICORN</span><br />22/12 - 19/1</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/aquarius/"><img src="<?= base_url()?>front-assets/images/header/Aquarius.png" class="img-responsive"><span class="rajshree">AQUARIUS</span><br />20/1 - 18/2</a></div>
  <div class="col-md-1"><a href="<?= base_url()?>horoscopes/sunsign/yearly/pisces/"><img src="<?= base_url()?>front-assets/images/header/Pisces.png" class="img-responsive"><span class="rajshree">PISCES</span><br />19/2 - 20/3</a></div>
</div>			
						</div>
				...
				<div class="tabbable-line">
					<ul class="nav nav-tabs on_win">
						...
						<!--</li>-->
							...
							<li class="active">
							<a href="#tab_default_07" id="nextyearsegment" data-toggle="tab">
							 <?php echo date("Y"); ?> </a>
						</li> 
					...
					<div class="tab-content">
						<div class="tab-pane" id="tab_default_02">
						   ...
						   <div class="col-md-1"><a href="#"><img src="<?= base_url()?>front-assets/images/header/<?php echo @$horodata[0]->rashi_name;?>.png" class="img-responsive"><span class="rajshree"><?php echo @$horodata[0]->rashi_name;?></span></a></div>
							...
							<div class"col-md-8 " style="text-align: justify; display: table; font-size:15px; line-height:1.8;">
						    <p class"sinl"><?php echo @$weeklyhorodata[0]->description;?></p>
						    <a href="<?= base_url()?>talk-to-astrologers">Click here for a more personalised reading</a>
						   ...
						   <div class="col-md-1"><a href="#"><img src="<?= base_url()?>front-assets/images/header/<?php echo @$horodata[0]->rashi_name;?>.png" class="img-responsive"><span class="rajshree"><?php echo @$horodata[0]->rashi_name;?></span></a></div>
							...
							<div class"col-md-8 " style="text-align: justify; display: table; font-size:15px; line-height:1.8;">
						    <p class"sinl"><?php echo @$monthlyhorodata[0]->description;?></p>
						    <a href="<?= base_url()?>talk-to-astrologers">Click here for a more personalised reading</a>
							...
							<div class="tab-pane active" id="tab_default_07">
							<div class"row">
						    	<div class"col-md-4">
						   <div class="col-md-1"><a href="#"><img src="<?= base_url()?>front-assets/images/header/<?php echo @$horodata[0]->rashi_name;?>.png" class="img-responsive"><span class="rajshree"><?php echo @$horodata[0]->rashi_name;?></span></a></div>
						</div>
...
<!--		<div class="row" style="display:block" id="currentyeardata">-->
...
<!--		<div class="row" style="display:none" id="nextyeardata">-->
...
<!--			<div class="list-group"> <a href="<?= base_url()?>horoscopes/<?php echo $this->uri->segment(2).'/yearly2020/'.$this->uri->segment(4).'/love/';?>" class="list-group-item "> -->
<!--			<h4 class="list-group-item-heading"><?php echo @$nextyeardata[0]->rashi_name.' '.@$nextyeardata[0]->horoscope_type;?> Love Horoscope</h4> -->
<!--			<p class="list-group-item-text"><?php echo substr(strip_tags(@$nextyeardata[0]->love_horoscope),0,100);?></p> <button type="button" class="btn btn-link pndt">Learn more...</button> </a> -->
<!--			<a href="<?= base_url()?>horoscopes/<?php echo $this->uri->segment(2).'/yearly2020/'.$this->uri->segment(4).'/career/';?>" class="list-group-item"> -->
<!--			<h4 class="list-group-item-heading"><?php echo @$nextyeardata[0]->rashi_name.' '.@$nextyeardata[0]->horoscope_type;?> Career Horoscope</h4> -->
<!--			<p class="list-group-item-text"><?php echo substr(strip_tags(@$nextyeardata[0]->career_horoscope),0,100);?></p> <button type="button" class="btn btn-link pndt">Learn more...</button> </a> -->
...
<!--			<div class="list-group"> -->
<!--			<a href="<?= base_url()?>horoscopes/<?php echo $this->uri->segment(2).'/yearly2020/'.$this->uri->segment(4).'/finance/';?>" class="list-group-item"> -->
<!--			<h4 class="list-group-item-heading"><?php echo @$nextyeardata[0]->rashi_name.' '.@$nextyeardata[0]->horoscope_type;?> Finance Horoscope</h4> -->
<!--			<p class="list-group-item-text"><?php echo substr(strip_tags(@$nextyeardata[0]->finance_horoscope),0,100);?></p> <button type="button" class="btn btn-link pndt">Learn more...</button> </a> -->
			
<!--				<a href="<?= base_url()?>horoscopes/<?php echo $this->uri->segment(2).'/yearly2020/'.$this->uri->segment(4).'/health/';?>" class="list-group-item"> -->
<!--			<h4 class="list-group-item-heading"><?php echo @$nextyeardata[0]->rashi_name.' '.@$nextyeardata[0]->horoscope_type;?> Health Horoscope</h4> -->
<!--			<p class="list-group-item-text"><?php echo substr(strip_tags(@$nextyeardata[0]->health_horoscope),0,100);?></p>  <button type="button" class="btn btn-link pndt">Learn more...</button>  </a> -->
