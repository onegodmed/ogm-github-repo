						...
						<div class="modal-design">
							...
							<form action="https://secure.payu.in/_payment" method="post" id="payuForm" name="payuForm">
								...
								<div class="form-group">
									<table width="100%" cellspacing="0" cellpadding="0" style="line-height: 40px; font-size: 14px; text-indent: 7px; border: 1px solid #aaa;">
										<tbody>
											<tr>
												...
												<td style="border-bottom:1px solid #aaa;">Rs. <span id="tot_amount">99</span>.00</td>
											</tr>
									...
									<input class="form-control" id="amount" name="amount" value="118" type="hidden" /> </div>
								<div class="form-group">
    ...
    $(".ast_packages_box1").click(function() {
		...
		$.ajax({
			...
			success: function(data) {
                ...
                // $('#tot_talktime').html(pack_amt_real);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 1) {
                        ...
                        $this->session->userdata('pack_amt_dsc') = pack_amt_dsc;

                        // Update wallet post success
                            $.ajax({
