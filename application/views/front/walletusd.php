...
<div class="ast_journal_wrapper ast_toppadder70 ast_bottompadder70 walletpage" >
	<div class="container">
		<div class="row">
			...
			<div class="serc_flds">
			  <form>
          <input type="text" value="" name="" class="pack_amt" placeholder="Enter Amount in USD" onkeypress="return isNumber(event)"/>
			...
			<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 astro-recharge" style="background: #f4f4f4;">
				...
				<div class="col-lg-4 col-md-4 col-sm-3 col-xs-6" >
					...
					<div class="ast_packages_box ast_packages_box1" id="packname<?php echo $row->package_price_dollar?>">
