   ...
   <div class="container">
            ...
            <div class="sidebar_wrapper">
               <div class="ast_team_box detail_discription">
                     ...
                     <div class="avtar-icon-dscpsn-detail">
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="star-rating">
                                 ...
                                 <p style=" font-weight:bold;">(<?php echo $totalstarrating; ?> ratings)</p>
                              </div>
                           </div>
                        </div>
                        <div class="row followup">
                           ...
                           <div class="col-md-6 col-xs-6 notifyme">
                              <div class="follow btn-style1"><button class="btn"> <i class="fa fa-bell-o profile-icon" aria-hidden="true"></i>Notify</button></div>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="communication">
                     <a class="popup-with-zoom-anim buy_btn online_queue" href="#signup-dialog" id="add_redirect"><i class="fa fa-phone" aria-hidden="true"></i> Call Now</a>
                     <span><i class="fa fa-comments call_btn1" aria-hidden="true"></i> <a href="#signup-dialog" id="add_redirect" class="popup-with-zoom-anim buy_btn online_queue cursor-pointer" style="color: #fff!important;">Chat</a> </span>
                  </div>
                  ...
                  <div class="astroModalPopupData"> 
                     ...
                     <a class="online_queue cursor-pointer" data-toggle="modal" data-target="#myModal"><i class="fa fa-phone" aria-hidden="true"></i> Call Now</a>
                  </div>
                  <?php } else { ?>
                  <div class="astroModalPopupData"> 
                     <input type="hidden" class="astroId" id="astroId_<?php echo $mamber[0]->id; ?>" name="astroId_<?php echo $mamber[0]->id; ?>" value="<?php echo $mamber[0]->id; ?>"/>
                  ...
                  <?php if ($mamber[0]->chat_status == "Online") {
                     ...
                     if ($call_duration == "" && $this->session->userdata('id') == "") {
                         ?>
                  <!--<a class="popup-with-zoom-anim buy_btn online_queue" href="#signup-dialog" id="add_redirect"><i class="fa fa-comments" aria-hidden="true"></i> Chat Now</a>-->
                  <?php } else if ($call_duration == "" && $this->session->userdata('id') != "") { ?>
                  <?php if (@$callSt == "Running" || @$callSt == "Accept") { ?>
                  ...
                  <?php } else{?>
                  <?php if ($this->session->userdata('countryCode') == 'IN') { ?> 
                  <div class="astroChatModalPopupData">
                     <input type="hidden" class="astroId" id="astroId_<?php echo $mamber[0]->id; ?>" name="astroId_<?php echo $mamber[0]->id; ?>" value="<?php echo $mamber[0]->id; ?>"/>
                     <input type="hidden" class="astroName"  name="astroName" value="<?php echo $mamber[0]->name; ?>"/>
                     <input type="hidden" class="walletbalance"  name="walletbalance" value="<?php echo $wallet_balence[0]->wallet_balence; ?>"/>
                     ...
                     <!--<a class="online_queue cursor-pointer" data-toggle="modal" data-target="#mychatModal"><i class="fa fa-comments" aria-hidden="true"></i> Chat Now</a>-->
                  </div>
                  <?php } else { ?>
                  <div class="astroChatModalPopupData">
                     <input type="hidden" class="astroId" id="astroId_<?php echo $mamber[0]->id; ?>" name="astroId_<?php echo $mamber[0]->id; ?>" value="<?php echo $mamber[0]->id; ?>"/>
                  ...
                  <?php } else if ($call_duration != "" && $this->session->userdata('id') == "") { ?>
                  <a  href="#signup-dialog" id="add_redirect" class="popup-with-zoom-anim buy_btn online_queue cursor-pointer" style="background:#f77403!important;color: #fff!important;font-size:15px;">Busy</a>
                  <?php } } else if($mamber[0]->chat_status == "Inactive"){ } else {?>
                  <a  class="online_queue cursor-pointer" style="background-color: #c5bbbb!important;color: #e0e0e0!important;border: 1px solid #c5bbbb !important;">Offline for Chat</a>
                  <?php }?>
                  <br>
               </div>
            </div>
      ...
      <div class=" row commenthere">
         ...
         <div class="col-md-4">
            <div class="availability">
               ...
               <h4 class="showavailavilitychart">Availability</h4>
      ...
      <div class="row chatandcallbtn">
         <div class="col-md-6 col-xs-6">
            ...
            <a href="#signup-dialog" id="add_redirect" class="popup-with-zoom-anim buy_btn online_queue cursor-pointer" style="color: #fff!important; position:relative;">Call:1.5/Min <i class="fa fa-phone phone-icon" aria-hidden="true" style="position:absolute; top:15px; font-size:18px; right:0px"></i></a> 
         </div>
         <div class="col-md-6 col-xs-6">
