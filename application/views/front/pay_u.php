...
<div class="main">
    ...
    <span><input type="text" id="key" name="key" placeholder="Merchant Key" value="gWX8Dxj9" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Merchant Salt:</label></span>
    <span><input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="HDSFHVQUOv" /></span>
    </div>
...
$('#payment_form').bind('keyup blur', function(){
    $.ajax({
          url: 'http://rcsieducation.com/horoscope/front/pay_u',
          type: 'post',
          data: JSON.stringify({ 
            key: $('#key').val(),
            salt: $('#salt').val(),
...
function launchBOLT()
{
    ...
    udf5: $('#udf5').val(),
    surl : "http://localhost/PHP_Bolt-master/sucsse",
    furl: "http://localhost/PHP_Bolt-master/failuar",
    mode: 'dropout' 
