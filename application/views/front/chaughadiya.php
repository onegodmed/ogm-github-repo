        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>panchang/chaughadiya">Chaughadiya Muhurta</a></li>
...
<h2 class="unmarg" style="display: inline-block;"><span id="top-heading-date" style="display: inline-block;">Chaughadiya Muhurta </h2>

</div>
<!--<button type="button" class="btn btn-warning csnow" style="float: right;"><a href="<?=base_url()?>Panchang/nextdata">Next</a></button>

<button type="button" id="getprev" class="btn btn-warning csnow" style="float: right;"><a href="<?=base_url()?>Panchang/previousdata">Prev</a><button>-->
</div>
</div>
</div></section>
...
<option value="bn" <?php if(($language == 'bn')|| ($language == 'Bengali')){echo "selected";} ?>>Bengali</option>
           ...
           <div class="col-md-3">
               ...
               <input type="submit"  id="submitBtn" class="btn btn-warning csnow" style="margin-top:26px;" value="Get Chaughadiya"/>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1 col-xs-offset-0">
                ...
                <h1>Chaughadiya for <?php echo $day; ?>, <?php echo $d; ?>&nbsp;<?php echo $m; ?> &nbsp;<?php echo $y; ?></h1>
            ...
            <div class="col-lg-12 col-md-12 col-sm-10 col-xs-12 col-lg-offset-0 col-md-offset-2 col-sm-offset-1 col-xs-offset-0">
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-1 col-xs-12">
                        <h4 class="chaughdiya-block-title sunrise-set unmarg--bottom">Day Chaughadiya</h4>
                    ...
                    <ul>
                        <?php foreach($chaughadiya['chaughadiya']['day'] as $arrdata) { ?>
                        <li class="border-bottom"><p class="muhuratDate muhurat-good"><strong><?php echo $arrdata['muhurta']; ?></strong> &nbsp; &nbsp;<?php echo $arrdata['time']; ?></p></li>
                    ...
                    <div class="col-md-4 col-md-offset-1 col-xs-12">
<h4 class="unmarg--bottom chaughdiya-block-title sunrise-set">Night Chaughadiya</h4>
<script type="text/x-handlebars-template" id="nightChaughadiyaTpl">
                <ul>

                    {{#each night}}
                    <li class="border-bottom"><p class="muhuratDate {{#noop}}{{this.muhurta}}{{/noop}}"><strong>{{this.muhurta}}</strong> &nbsp; &nbsp; {{this.time}}</p></li>
                    {{/each}}
                </ul>
                </script>
<div class="" id="dayChaughadiya">
                    <ul>
                        <?php foreach($chaughadiya['chaughadiya']['night'] as $arrdata) { ?>
                        <li class="border-bottom"><p class="muhuratDate muhurat-good"><strong><?php echo $arrdata['muhurta']; ?></strong> &nbsp; &nbsp;<?php echo $arrdata['time']; ?></p></li>
...
<p class="">Ghadi is an ancient measure for calculations of time in India roughly equivalent to 24 minutes. Cho-ghadiya means four ghadi which totals to 96 minutes. Most of chaughadiya are of a figure around 96 minutes.</p>
<h4 class="m-b-5">There are totally seven types of Choghdiya.</h4>
<div class="legend-bg legend-bg1 pull-left"> </div>
<p class="m-b-5">-Amrit, Shubh and Labh are considered the most auspicious Chaughadiyas.</p>
<div class="legend-bg legend-bg2 pull-left"></div>
<p class="m-b-5">-Udveg, Kal and Rog is considered inauspicious Chaughadiyas.</p>
<div class="legend-bg legend-bg3 pull-left"></div>
<p class="m-b-5">-Char is considered as good Choghadiya.</p>
</div>
...
.ast_heading span{color: #f77403;}
    ...
    padding: 10px;
    text-align: center;
    background: #f0f8ff;margin-bottom:0px;
}
.muhurat-good {
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.status == 'success'){
                    window.location.href="<?= base_url(); ?>panchang/chaughadiya";
                }
