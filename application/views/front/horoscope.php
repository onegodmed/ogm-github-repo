			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-lg-push-7 col-md-push-7 col-sm-push-0 col-xs-push-0">
				<div class="ast_about_info_img">
					<div class="about_slider">
						<div class="card c" id="first"><img src="<?php echo base_url();?>front-assets/images/content/about/hr-abt1.jpg" alt="" class="img-responsive"></div>
						<div class="card a" id="second"><img src="<?php echo base_url();?>front-assets/images/content/about/hr-abt2.jpg" alt="" class="img-responsive"></div>
