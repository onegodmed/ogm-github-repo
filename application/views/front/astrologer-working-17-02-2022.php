...
<?php if($mamber[0]->status != "Online" && $mamber[0]->chat_status != "Online") { ?>
                  ...
                  <div class="descriptionofAstro">
                     ...
                     <?php }} ?>
                     <?php echo $services[0]->video_price . "/" . $services[0]->price_unit ?></strong> </a>
                     <?php } else { ?>
                  ...
                  <div class="profile-tele">
                     <a  class="online_queue cursor-pointer" style="background-color: #c5bbbb!important;border: 1px solid #c5bbbb !important;"><i class="fa fa-phone" aria-hidden="true"></i>Offline 
                 ...
                 <div class="profile-tele"> 
                 <div class="">   
                  <a  class="online_queue cursor-pointer" style="background-color: #c5bbbb!important;border: 1px solid #c5bbbb !important;"><i class="fa fa-comments" aria-hidden="true"></i>Offline 
            ...
            <div class="cust_chat_details">
               <form>
                  ...
                  <div class="text-center">
                     <button type="button" id="chatproceed" class="btn ast_btn btn_radius btn-default btn-rounded btn-shadowed">Start Chat</button>
                  </div>
               </form>
            </div>
         </div>
            ...
            if (country_code == "IN" && call_count == 0) {
               ...
               sessionStatusRequest = $.ajax({
                   ...
                   success: function (data) {
                     ...
                     //       // alert("Astro ID -> " + '<?php echo $mamber[0]->id;?>');
                     //       // alert("<?= base_url() ?>rest-api/userdetail/send");
                           
                     //       $.ajax({
                     //          url: "<?= base_url() ?>rest-api/userdetail/send",
                     //          method: "POST",
                     //          data: {userid: "<?php echo $mamber[0]->id;?>"},
                     //          success: function(data) {
