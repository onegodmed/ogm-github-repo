        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="animate__animated animate__backInUp">Get upto 100% Cashback <sup>*</sup> & 1 minute Free for First Recharge.</h1>
                    <p class="animate__animated animate__backInUp">India's best Live Astrology consulting platform</p>
                </div>
            </div>
            <div class="item">
...
<div class="horoscope-section">
    <div class="container">
        <h2 class="title">Daily <span>Horoscope</span></h2>
        <div class="row">
            ...
            <div class="col-xs-6 col-md-3 col-lg-2">
                <a href="<?= base_url() ?>horoscopes/sunsign/daily/taurus/">
                    <div class="card">
                        <img src="<?php base_url() ?>assets/categories_image/icon/icon-Taurus.png" alt="Taurus">
                        <span class="name">Taurus</span>
                        <span class="date">20/4 - 20/5</span>
                    </div>
                </a>
            </div>
            <div class="col-xs-6 col-md-3 col-lg-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 desk">
                <div class="ast_about_info_img">
                    ...
                    <p>onegodmed.com strongly believes in the Power of God and helps imbibe that very belief into individuals who are unable to find the correct path. Our team houses the best spiritual experts, holding experience and expertise in their respective fields, ready to guide you at every step of your life.</p>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="ast_about_info">
                        ...
                        <div id="target"><strong>Our vision</strong> <br>
                            ...
                            onegodmed.com strongly believes in the Power of God and helps imbibe that very belief into individuals who are unable to find the correct path. Our team houses the best spiritual experts, holding experience and expertise in their respective fields, ready to guide you at every step of your life.
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <div class=" col-md-3 col-xs-12">
                        <div class="ingGray"></div>
                        <div class=" line17  text-center"> <a class="Decoration_none pty"> 
                    ...
                    <div class=" col-md-3 col-xs-12">
                        <div class="ingGray"></div>
                        <div class=" font14 line17  text-center "> <a class="Decoration_none pty">
