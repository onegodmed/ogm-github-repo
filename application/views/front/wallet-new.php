...
.actuall-you-get-box .value.strikethrough{
...
<div class="ast_journal_wrapper ast_toppadder70 ast_bottompadder70 walletpage">
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-3 col-xs-3 indiancurrency"> <img class="wallet_class" src="<?php echo base_url('front-assets/images/wallet icon.png'); ?>" style="width:30%"> </div>
			<div class="col-lg-6 col-md-6 col-sm-9 col-xs-9 price">
				<div class="ast_journal_box_wrapper">
					<form>
						...
						<!--<span>Please select your calling pack</span>--></form>
				</div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 astro-recharge new-wallet-design" style="background: #f4f4f4;">
				<h3 style="text-align:center;padding-bottom:30px">Select Packages to <span style="color:#fa8819">Recharge your wallet</span></h3>
				<!--- New code added Forpackages ---------------->
                <?php
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
					<!-- package card -->
					<div class="package-card ast_packages_box1" id="packname200">
						<input type="hidden" class="pack_amt" name="payble_amount" value="<?php echo $package[$i]->package_price;?>">
						<input type="hidden" class="pack_name" name="package_name" value="<?php echo $package[$i]->package_name;?>">
                        <input type="hidden" class="pack_get" name="package_get" value="<?php echo $package[$i]->package_price_dollar;?>">
                        
						<input type="hidden" name="onti200" id="onti200" value="0"><div class="offer"><div class="text" id="ont200" >Rs. <?php echo ($package[$i]->package_price_dollar)-($package[$i]->package_price);?> EXTRA</div></div>
                        	<h3 class="title"><?php echo $package[$i]->package_name;?></h3>
							<div class="box top">
								<div class="wrapper">
									<div class="you-pay-box"> <span class="text">YOU<br />PAY</span> <span class="value"><?php echo $package[$i]->package_price;?></span> </div>
									<!-- <div class="actuall-you-get-box"> <span class="value strikethrough">₹ 200</span> </div> -->
                                    <div class="you-get-box"> <span class="text">YOU<br />GET</span> <span class="value"><?php echo $package[$i]->package_price_dollar;?></span> </div>	
								</div>
							</div>
                ...
                <?php // 2nd time onwards
                if($pCheck){
                ?>
                
                <?php for($i=2; $i < count($package); $i++){?>
				<!---Package 1---->
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
					<!-- package card -->
					<div class="package-card ast_packages_box1" id="packname200">
                ...
                <div class="socal_md showonmobile">
						<div>
							<h4> We Accept</h4>
						</div>
						<ul>
							<li><img src="<?= base_url() ?>front-assets/images/american-express.png"></li>
							<li><img src="<?= base_url() ?>front-assets/images/maestro.png"></li>
							<li><img src="<?= base_url() ?>front-assets/images/mastercard.png"></li>
							<li><img src="<?= base_url() ?>front-assets/images/paypal.png"></li>
							<li><img src="<?= base_url() ?>front-assets/images/rupay.png"></li>
							<li><img src="<?= base_url() ?>front-assets/images/visa.png"></li>
						</ul>
					</div>
				<!-------End of new packages------------------------------->
			</div>
				...
				<div id="myModalopn">
					<div id="sidebar">
						<div class="modal-design">
							...
							<input class="form-control" id="pack_amount_orginal" name="pack_amount_orginal" value="1000" type="hidden" />
							...
							<form action="https://secure.payu.in/_payment" method="post" id="payuForm" name="payuForm">
								...
								<div class="form-group">
									<table width="100%" cellspacing="0" cellpadding="0" style="line-height: 40px; font-size: 14px; text-indent: 7px; border: 1px solid #aaa;">
										<tbody>
											<tr>
												...
												<td style="border-bottom:1px solid #aaa;">Rs. <span id="tot_amount">999</span>.00</td>
											</tr>
											<!-- <tr style="background-color: #ededed" id="cashbackrow">
												<td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">Cash Back </td>
												<td style="border-bottom:1px solid #aaa;">Rs. <span id="cashback_price">00</span>.00</td>
											</tr> -->
											<!-- <tr style="background-color: #ededed;display:none;" id="extrarow">
												<td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">Cash Back </td>
												<td style="border-bottom:1px solid #aaa;">Rs. <span id="extra_price">00</span>.00</td>
											</tr> -->
											<tr>
												<td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">GST @ 18.00 % </td>
												<td style="border-bottom:1px solid #aaa;">Rs. <span id="gst_price">180</span></td>
											</tr>
											<tr style="background-color: #ededed">
												<td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">Talktime Value</td>
												<td style="border-bottom:1px solid #aaa;">Rs. <span id="tot_talktime">1200</span>.00</td>
											</tr>
											<tr style=" background-color: #ff871f; color: #fff; font-weight: bold;">
												<td style="border-right:1px solid #aaa;">Net Amount Payable (Rs.)</td>
												<td style="">Rs. <span id="net_price">1178</span>.00</td>
											</tr>
										</tbody>
									</table>
									<div class="casbacktext flexprop">
										<p>Cash Back will be added to Your Wallet After Recharge. </p> <i class="fa fa-times-circle" aria-hidden="true"></i> </div>
									<p id="promo" style="text-decoration: underline;cursor:pointer;">Do you have coupon code ?</p>
									<div class="row">
										<div class="col-xs-9">
											<input class="form-control" placeholder="Enter your coupon code" type="text" id="promocode" style="display:none" />
										</div>
									...
									<input class="form-control" id="amount" name="amount" value="1178" type="hidden" /> </div>
								<div class="form-group">
									<input type="hidden" class="form-control" name="firstname" id="firstname" value="<?php echo $this->session->userdata('name') ?>" readonly /> </div>
								<div class="form-group">
									<input type="hidden" class="form-control" id="productinfo" name="productinfo" readonly value="SATURN" />
									<input type="hidden" class="form-control" name="email" id="email" value="<?php echo $this->session->userdata('username') ?>" readonly /> </div>
								<div class="form-group">
									<input type="hidden" class="form-control" name="phone" value="<?php echo $this->session->userdata('mobile') ?>" readonly />
									<input type="hidden" class="form-control" name="address1" value="" readonly /> </div>
								<div class="form-group">
									...
									<input name="curl" value="<?php echo base_url() ?>status/" type="hidden" /> </div>
...
<script>
    $(document).ready(function() {
        $(".casbacktext i.fa").click(function() {
		$(".casbacktext").fadeOut(1000);
	});
    ...
    $(".ast_packages_box1").click(function() {
		...
		var pack_amt_real = $(this).children('input.pack_get').val();
        ...
        // <?php //echo $_SESSION['base_price_wo_gst'];?> = pack_amt;

        // alert(pack_amt);

        // var disc_price = (pack_amt * 10) / 100;
        var disc_price = (0 * 100) / 100;
        ...
        $('#tot_talktime').val(pack_amt_real);
		...
		//Add amount for wallet Update...
		$.ajax({
			type: "POST",
			url: '<?php echo site_url("ajax/packageRecharge")?>',
			data: {
				'pack_name': pack_name,
				'pack_amt': pack_amt,
				'gst': gst,
                'pack_amt_real' : pack_amt_real,
                'total_amt': total_amt,
			},
			dataType: "json",
			cache: false,
			success: function(data) {
				$('#extrarow').hide();
				$('#cashbackrow').show();
				$('#tot_amount').html(data[0].pack_amt);
				$('#cashback_price').html(data[0].cash_back);
				$('#pack_amount').val(data[0].ac_update);
				$('#pack_amount_orginal').val(data[0].pack_amt);
				$('#pack_gst').val(data[0].gst_amt);
				$('#pack_after_disc').val(new_price);
				$('#amount').val(data[0].total_amount);
				$('#merchant_total').val((data[0].total_amount));
				$('#net_price').html(data[0].total_amount);
				$('#productinfo').val(data[0].package_name);
				$('#package_name').val(data[0].package_name);
				$('#gst_price').html(data[0].gst_amt);
				$('#pack_disc').val(disc_price);

                // TO DO - commented for value updates
				$('#tot_talktime').html(data[0].ac_update);
               
                
				/*  
                if(data[0].pack_amt==200) {     
                    var valcheckFirst = $('#onti200').val(); 
                    if(valcheckFirst==1){
                       $('#ont200').html('0% cashback');
                   }
                }
  
               if(data[0].pack_amt==500){
                    var valcheckFirst5 = $('#onti500').val(); 
                    if(valcheckFirst5==1){
                        $('#ont500').html('5% cashback');
                   }       
                }
                */
			}
        ...
        $("#apply_promo").click(function() {
            ...
            //var real_price = $('#pack_amount').val();
			var real_price = $('#pack_amount_orginal').val();
            ...
            if (real_price > 100) {
                ...
                if (coupon_code != '') {
                    ...
                    $.ajax({    
                        url: "<?= base_url('front/ajax_get_coupon')?>",
                        type: 'POST',
                        dataType: "json",
                        data: {
                            'coupon': coupon_code
                        ...
                        success: function(response) {
                           // alert("Response " + response.status);
                            if(response.status === 1){
								$('#extrarow').show();
								$('#cashbackrow').hide();
                                // alert("pack_amt" + pack_amt_real);
                                var coupon = parseInt(parseInt(real_price * response.coupon[0].discount_parcent) / 100);
                               // alert(coupon); // cash back amount								
                                var newamt = parseInt(parseInt(real_price) + parseInt(coupon));
                                // alert("AMT and Cashback total" + newamt);
                                var gstcoupon = parseInt((real_price * 18) / 100);
								$('#extra_price').html(coupon);
                                $('#coupon_error').html('Your Cashback Amount Is Rs. '+ coupon);
                                // alert("GST coupon" + gstcoupon);
                                total_coupon_dis = Math.round(parseInt(real_price) + parseInt(gstcoupon));
                                //console.log(total_coupon_dis);
                                // alert(total_coupon_dis);
                                ...
                                $('#coupon_error').html('Coupon Cashback value is '+coupon);
        ...
        $("#pay_now").click(function() {
            ...
            // alert("pack_amt"+pack_amt); // base amount pay - 118/ net amount payable
            // alert("pack_amt_dsc"+pack_amt_dsc); // Talk time -> amount get
            // alert("pack_name"+pack_name); // EARTH
            // alert("pack_disc"+disc_price); // 0
            // alert("pack_gst"+pack_gst); // 18
            // alert("pack_after_disc"+pack_after_disc); // base price - 99
            // alert("pack_coupon"+pack_coupon);
            // alert("pack_coupon_disc"+pack_coupon_disc);
            // alert("cust_email"+cust_email);
            // alert("cust_name"+cust_name);
            // alert("cust_mobile"+cust_mobile);
            // alert("cust_id"+cust_id);


            // <?php //$this->session->userdata('pack_amt_dsc')?> = pack_amt_dsc;
                    ...
                    <div class="form-group">
                        <table width="100%" cellspacing="0" cellpadding="0" style="line-height: 40px; font-size: 14px; text-indent: 7px; border: 1px solid #aaa;">
                            <tbody>
                                <tr>
                                    <td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">Amount</td>
                                    <td style="border-bottom:1px solid #aaa;">Rs. <span id="tot_amountn">1000</span>.00</td>
                                </tr>
                                <tr style="background-color: #ededed">
                                    <td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">Cash Back </td>
                                       <td style="border-bottom:1px solid #aaa;">Rs. <span id="cashback_pricen">00</span>.00</td>
                                 </tr>
                                <tr>
                                    <td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">GST @ 18.00 % </td>
                                    <td style="border-bottom:1px solid #aaa;">Rs. <span id="gst_pricen">180.00</span></td>
                                </tr>
                                <tr style="background-color: #ededed">
                                    <td style="border-bottom:1px solid #aaa; border-right:1px solid #aaa;">Talktime Value</td>
                                    <td style="border-bottom:1px solid #aaa;">Rs. <span id="tot_talktimen">1000</span>.00</td>
                                </tr>
                                <tr style=" background-color: #ff871f; color: #fff; font-weight: bold;">
                                    <td style="border-right:1px solid #aaa;">Net Amount Payable (Rs.)</td>
                                    <td style="">Rs. <span id="net_pricen">1180</span>.00</td>
                                </tr>
                            </tbody>
                        </table>
                        <br>
                        ...
                        <p style="display:none" id="coupon_error"></p>
                        <input class="form-control" id="amount" name="amount" value="118" type="hidden" />
                    </div>
                    <div class="form-group">
