        ...
        <div class="container-fluid">
            <div class="row-item">
                ...
                <div class="middle-box">
                    <ul class="menu-items">
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>">Free Kundali</a>
                        </li>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>">Match Making</a>
                        </li>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>">Numerology</a>
                        </li>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>">Panchang</a>
                        </li>
                    </ul>
                </div>
                <div class="last-box">
                            ...
                            foreach ($resultSet as $wallet_bal); { ?>
                                <div class="col-item">
                                    <button class="btn btn-default btn-rounded " type="button">
                                        ...
                                        <?php } else { ?>
                                            <i class="fa fa-google-wallet" aria-hidden="true"></i> USD $ <?php echo $wallet_bal->wallet_balence; ?> 0 Recharge Wallet
                                    </button>
                                </div>
                    <?php } } } ?>
                    <?php } else { ?>
