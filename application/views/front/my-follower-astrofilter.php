...
<!-- Loader ends here -->
<div id="partial">
   <div class="articlemrg askastro followingpage">
      <?php
                        ...
                        <div class="review_mobile">
                           <?php
                              ...
                              for ($i = 0; $i < 1; $i++) {
                                  ...
                                  ?>
                           <span class="<?php echo $tmp_class ?>" data-rating="1"></span> <span><?php echo number_format($rating1[0]->rating, 2); ?></span>
                           <?php } ?>
                        </div>
...
$shivam = $this->db->select('*')->from('follow')->where(array('astro_id'=>$astroid,'user_id'=>$this->session->userdata('id')))->get()->row();
 ...
 ?>
                  ...
                  <?php } else { ?>
                    <div class="follow btn-style1">
                     <a href="#signup-dialog"><button class="btn">Follow</button></a>
                    </div>
                  <?php } ?>
               ...
               <div class="as_profile_text">
                  ...
                  <?php
                     if ($value->status == "Online") {
                         ...
                         if ($call_duration == "" && $this->session->userdata('id') == "") {
                             ?>
                  <div class="onlineastro"><div class="online-inner"><a  href="#signup-dialog" id="add_redirect"  class="popup-with-zoom-anim buy_btn online_queue cursor-pointer" style="color: #fff!important;">Call</a> <i class="fa fa-phone phone-icon" aria-hidden="true"></i></div> </div>
                ...
                <div class="online-wrapper">    
                  <div class="astroModalPopup"> 
                     ...
                     <a  class="online_queue cursor-pointer" style="color: #fff!important;">Call <i class="fa fa-phone phone-icon" aria-hidden="true"></i></a> 
                  </div>
                  <?php } else { ?>
                  <div class="astroModalPopup"> 
                     <input type="hidden" class="astroId" id="astroId_<?php echo $value->id; ?>" name="astroId_<?php echo $value->id; ?>" value="<?php echo $value->id; ?>"/>
                  ...
                  <div class="wrppr">
                     ...
                     if ($value->chat_status == "Online") {
                         ...
                         if ($call_duration == "" && $this->session->userdata('id') == "") {
                             ?>  
                         <div class="chatingbtn myastro-tele">
                         <a class="online_queue astro-offline">Chat</a><i class="fa fa-comments" aria-hidden="true"></i>
                  ...
                  <div class="astroModalPopup"> 
                     ...
                     <div class="onlineastro">
                         <div class="online-inner">
                         <a  class="online_queue cursor-pointer" style="color: #fff!important;">Chat</a> <i class="fa fa-comments" aria-hidden="true"></i>
                         </div>
                     </div>
                  ...
                  <?php } ?>
                  <?php } else if ($call_duration != "" && $this->session->userdata('id') == "") { ?>
                  <div> <a  href="#signup-dialog" id="add_redirect" class="popup-with-zoom-anim buy_btn online_queue cursor-pointer" style="background:#f77403!important;color: #fff!important;font-size:15px;">Busy</a></div>
                  <?php
                     }
                     } else {
                     ?>
