...
<!-- Loader ends here -->
<div id="partial">
   <div class="articlemrg askastro" id="astlist">
      <?php
         if (!empty(@$astro)) {
			...
			<?php
                        ...
                        ?>		 
      <div class="li astrolist" id="19328" data-price="<?php echo $final_price; ?>" data-rating='<?php echo number_format($rating1[0]->rating, 2); ?>' data-exp='<?php echo $asexperience; ?>'>
 ...
 ?>
               ...
               <div class="as_profile_text">
                  <ul class="as_profile_text_ul ">
                     ...
                     <?php }?>
                     <li> <i class="fa fa-inr" aria-hidden="true"></i> <span class="discount_price">Call: 
					 <?php if($actual_call_price > 0){?><span> <strike> <?php echo $actual_call_price; ?><span>/Min</span></strike></span><?php }?><span> <?php echo $final_price; ?><span class="smalltxt">/Min</span></span></span> </li>
                     ...
                     <?php } else { ?>       
                     <li><i class="fa fa-usd" aria-hidden="true"></i> <span class="discount_price">Call:<span> USD $ <?php echo $dollar_price; ?><span>/Min</span></span></span> </li>
                  ...
                  <?php } else { ?>
                    <div class="astroModalPopup"> 
                       ...
                       <div class="onlineastro">
                           <div class="online-inner">
                           <a  class="buy_btn online_queue JoinCheck"   style="background:#f77403!important;color: #fff!important;font-size:15px;"><?php if(isset($userID)) { if(((isset($userID[0]) &&$userID[0] == $this->session->userdata('id')) || (isset($userID[1]) && $userID[1] == $this->session->userdata('id')))) {?>Queue Joined <?php } else { ?> <span ><i class="fa fa-user-plus" aria-hidden="true"></i><i class="fa fa-user-plus" aria-hidden="true"></i> JoinQ </span>  <?php } }else { ?>  <span ><i class="fa fa-user-plus" aria-hidden="true"></i> JoinQ </span> <?php }?></a>
                           </div>
                  ...
                  <div> <?php if ($queue == '2') { ?>
                     <a data-toggle="modal" data-target="#astroModal" class="buy_btn online_queue" style="background:#f77403!important;color: #fff!important;font-size:15px;">Busy</a>
                     <?php } else { ?>
                     <a  class="buy_btn online_queue JoinCheck" style="background:#f77403!important;color: #fff!important;font-size:15px;"><i class="fa fa-user-plus" aria-hidden="true"></i> JoinQ</a>
                     <?php } ?>
                  </div>
                  <?php
                     }
                  ...
                  <div class="callbtn btnvnd<?php if(($value->next_avail_call)!='')  { ?> msgcame<?php } ?>">
                     <div class="follow btn-style1">
                    <?php if($this->session->userdata('id') == '' ){?>
...
// Notify Me Code
   function notifyMe(userId, astroId){
       var valName = $('#'+astroId).text().trim(); 
        ...
        var curName = $('#'+astroId).data('id').trim();
        alert(curName);
   if(userId==''){
    $('#login-dialog').show();
    return false
