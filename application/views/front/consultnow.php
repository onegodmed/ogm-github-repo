...
<div class="ast_about_wrapper ast_toppadder70 ast_bottompadder70 dddd" style="background-color:#f3eeee">
   ...
   <div class="container">
      <!-- Chat html -->
      <div class="row">
         <!-- <button class="btn"  data-toggle="modal" data-target="#notifySucess">notifySucess</button>  -->
      ...
      <!-- Previous astrologer code end here -->
   </div>
</div>
<style>
   div#myModal {
...
<div class="notifyModal" id="notifySucess">
         ...
         <div class="modal-body">
            ...
            <p id="crnt">We will notify you once Deepali is available</p>
         </div>
   ...
   <div class="modal" id="myModal2" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-style">
         <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               <h4 class="modal-title" id="exampleModalLabel">Your Call Is In Process... </h4>
            </div>
            <p id="connect_astro"></p>
            <div class="modal-body bg-gray">
               <div class="example">
                  <div class="timeLefttext">
                     You Will Received the Call Within Next 1 Minute. 
                        If Doesn't, You Can please try again or Choose Another Astrologer.
                  </div>
