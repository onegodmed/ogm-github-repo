...
<body class="overflow">
    ...
    <!-- otp Verification -->
    <div class="modal fade custom phoneverification" data-keyboard="false" data-backdrop="static" id="otpverification">
                ...
                <div class="modal-body text-center">
                    <div class="user-icon">
                        <div id="otpsignup">
                           ...
                           <input type="tel" id="signdigit-6" name="con_password6" data-next="con_password-6" class="inputs" maxlength="1" data-previous="signdigit-5"> -->
                            <input id="digit1" type="number" class="val1 inputs" maxlength="1" onkeyup="onKeyUpEvent(1, event)" onfocus="onFocusEvent(1)">
                            <input id="digit2" type="number" class="val2 inputs" maxlength="1" onkeyup="onKeyUpEvent(2, event)" onfocus="onFocusEvent(2)">
                            <input id="digit5" type="number" class="val3 inputs" maxlength="1" onkeyup="onKeyUpEvent(3, event)" onfocus="onFocusEvent(3)">
                            <input id="digit6" type="number" class="val4 inputs" maxlength="1" onkeyup="onKeyUpEvent(4, event)" onfocus="onFocusEvent(4)">
                            <!-- <input id="digit5" type="number" class="val5 inputs" maxlength="1" onkeyup="onKeyUpEvent(5, event)" onfocus="onFocusEvent(5)">
                           <input id="digit6" type="number" class="val6 inputs" maxlength="1" onkeyup="onKeyUpEvent(6, event)" onfocus="onFocusEvent(6)"> -->
    ...
    <div id="login-dialog" class="zoom-anim-dialog mfp-hide">
        ...
        <div id="otpmobile" style="display:none">
            ...
            <br>
            <button type="button" class="ast_btn disabledHref loginsubmit" id="loginsubmit">Verify OTP</button>
        </div>
    ...
    <div class="sidebar-new">
      <ul>
        <li><a href="#">Home</a></li>
        <li><a href="<?php echo base_url();?>talk-to-astrologers">Talk to Astrologers</a></li>
        ...
        <li>
          <a class="dropdown-btn" href="#"
            >Vedic Astrology <i class="fa fa-chevron-down"></i
          ></a>
          <ul>
        ...
        <li>
          <a class="dropdown-btn" href="#"
            >Premium Reports <i class="fa fa-chevron-down"></i
          ></a>
          <ul>
            <li>
              <a href="#">Element 1</a>
    ...
    <div class="header-new">
      <div class="wrapper">
        <img src="<?php echo base_url(); ?>front-assets/images/header/menu.png" alt="menu icon" class="menu-btn" />
        <div class="logo-box">
        ...
        <div class="menu">
          <div class="top">
            <ul>
              ...
              <li>
                <a href="<?php echo base_url();?>numerology">Numerology Calculator</a>
              </li>
              <li>
              ...
              <li>
                <a class="btn btn-default btn-rounded btn-shadowed" href="#"
          ...
          <div class="bottom">
            <ul>
              ...
              <li>
                <a class="btn btn-default btn-rounded btn-shadowed" href="<?php echo base_url();?>talk-to-astrologers"
                  >Talk to Astrologer</a
                >
              </li>

              <li>
                <a class="btn btn-default btn-rounded btn-shadowed" href="<?php echo base_url();?>chat-with-astrologer"
                  >Chat with Astrologer</a
                >
              </li>
              <li>
                <a href="#">Free Horoscope</a>
              </li>
              <li>
                <div class="dropdown">
                  <a
                    id="astrologyDropdown"
                    type="button"
                    ...
                    href="#"
                  >
                    Vedic Astrology <span class="caret"></span>
                  </a>
              ...
              <li>
                <div class="dropdown">
                  <a
                    ...
                    href="#"
                  >
                    Premium Report<span class="caret"></span>
                  </a>
        ...
        <div class="menu">
          <div class="top">
            <ul>
              ...
              <li>
                <a class="btn btn-default btn-rounded btn-shadowed" href="<?php echo base_url();?>#login-dialog"
                  ><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a
                >
              </li>
              <li>
              ...
              <li>
                <a class="btn btn-default btn-rounded btn-shadowed" href="<?php echo base_url();?>wallet"
                  ><i class="fa fa-google-wallet" aria-hidden="true"></i>
                  Recharge Wallet</a
                >
              </li>
    ...
    <!--
     <div class="sidebar">
        <ul>
            ...
            <li><a href="#">Talk to Astrologers</a></li>
            <li><a href="#">Chat with Astrologers</a></li>
            <li><a href="<?= base_url() ?>horoscopes/">Horoscope</a></li>
            <li>
                <a class="dropdown-btn" href="#">Astrology <i class="fa fa-chevron-down"></i></a>
                <ul>
            ...
            <li>
                <a class="dropdown-btn" href="#">Premium Reports <i class="fa fa-chevron-down"></i></a>
                <ul>
                    <?php foreach ($super_cat as $row) { ?>
            ...
            <div class="wrapper d-flex justify-content-between align-items-center">
                ...
                <div class="menu-box">
                    <ul class="menu-items">
                        ...
                        <li class="menu-item">
                            <a class="btn btn-default btn-rounded btn-shadowed" href="<?= base_url() ?>chat-with-astrologer/s">Chat with astrologer</a>
                        </li>
                        <li class="menu-item">
