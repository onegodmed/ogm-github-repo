...
<!--BKnowcrumb end-->
<!--About Us Start-->
<div class="ast_about_wrapper ast_toppadder70 ast_bottompadder70 chat-to-astro">
   <!--start-->
   <div class="container">
      <div class="row">
                     ...
                     <div class="GrayColor_light_a  font14 line17 ">
                        ...
                        <?php if ($this->session->userdata('id') == '') { ?>
                           ...
                           ?>
                              ...
                              <span class="GrayColor_light_a font12Mobile"><span><?php echo $astrname[0]; ?></span></span>
                           </a>
                        <?php } ?>
                     </div>
                  </div>
                  ...
                  <div class="fliter-box">
                     ...
                     <div class="shortby action none_mb_pg">
                        ...
                        <div class="button-group panel panel_heading">
                           ...
                           <li>
                              <label class="small" ><input type="radio" name="astrosort" class="common_selector1 astroPrice pricedesc" onclick="sortPrice()" value="3" />Price:High To Low</label>
                           </li>
                           <li>
                              <label  class="small"><input type="radio" name="astrosort" class="common_selector1 astroPrice priceasc" onclick="sortPrice()" value="4" />Price:Low to High</label>
                           </li>
                           <li>
                              <label class="small"><input type="radio" name="astrosort" class="common_selector1 astrorating ratingasc" value="5" onclick="sortRating()"  />Rating:Low to High</label>
                           </li>
                           <li>
                              <label class="small" ><input type="radio" name="astrosort" class="common_selector1 astrorating ratingdesc" value="6" onclick="sortRating()" />Rating:High to Low</label>
                           </li>
                           <li>
                              <label class="small" ><input type="radio" name="astrosort" class="common_selector1 astroexpe expasc" value="7" onclick="sortExp()" />Exp:Low to High</label>
                           </li>
                           <li>
                              <label class="small"><input type="radio" name="astrosort" class="common_selector1 astroexpe expdesc" value="8" onclick="sortExp()" />Exp:High to Low</label>
                           </li>
                        </ul>
                        </div>
                     </div>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <?php if ($this->session->userdata('countryCode') == 'IN') { ?>
               <h4 class="modal-title"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Insufficient Balance: Rs. <?php echo $wallet_balence[0]->wallet_balence; ?></h4>
            <?php } else { ?>
               <h4 class="modal-title"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Insufficient Balance: USD $ <?php echo $wallet_balence[0]->wallet_balence; ?></h4>
            <?php } ?>
         </div>
         <!-- Modal body -->
         <div class="modal-body">
            <label>Your wallet balance is low.<p> To Chat with <span id="astro_name"></span> You Should Have Minimum 5 Minute Balance In Your Wallet.</p> Please recharge your wallet.</label><br><br>
...
<script>
   ...
   $(".common_selector1").click(function() {
      ...
      var newCheckVal = $(this).val().replace(/[^a-z0-9\s]/gi, '').replace(/[_\s]/g, '');
      if ($(this).prop("checked") == true) {
         html += '<span id="' + newCheckVal + '" class="btn btn-default filterAd margin_Rgt10"><span>' + $(this).parent().text().trim() + ' </span><a class="font14" aria-hidden="true" onclick="CloseFilterSpan1(\'' + $(this).parent().text().trim() + '\', \'' + newCheckVal + '\')">X</a></span>';
         //console.log("Checkbox is checked.");
      } else if ($(this).prop("checked") == false) {
         //console.log("Checkbox is unchecked.");
         appendHtml = false;
      ...
      if (appendHtml) {
         $('#FilterList').css("display", "block");
         $("#sortlistInner").html(html);
      } else {
         $("#" + newCheckVal).remove();
      }

   })
function CloseFilterSpan1(id, newval)
{
	$('#'+newval).remove();
	if(newval==3)
	{
		$('.pricedesc').prop("checked", false);
	}
	if(newval==4)
	{
	...
	if(newval==5)
	{
		$('.ratingasc').prop("checked", false);
	}
	if(newval==6)
	{
		$('.ratingdesc').prop("checked", false);
	}
	if(newval==7)
	{
		$('.expasc').prop("checked", false);
	}
	if(newval==8)
	{
		$('.expdesc').prop("checked", false);
	}
	
	if(($('#filterlistInner').html()).trim()=='' && ($('#filterlistInner').html()).trim()=='')
	{
		$('#FilterList').hide();
	}
   ...
   function CloseFilterSpan(val, id) {
      $('.common_selector').each(function() {
         if (id != "all") {
            ...
            $(this).prop("checked", false);
			 $('.common_selector1').prop("checked", false);           
			$('#sortlistInner').html('');
         }
