                 ...
                 <div class="col-md-6 col-sm-8 frm form-shadow">
                    <div class="row">
                            ...
                            <form >
                                <div class="mtb name">
                                        ...
                                        <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control" id="bname" placeholder="Full Name">
                                                <p id="errbnamemsg" style="display:none;color:red"></p>
                                            </div>
                                        </div>
                                ...
                                <div class="dob mtb">
                                        ...
                                        <div class="col-md-4 col-xs-4">
                                            <select class="kundli_match_select valid" data-val="true" data-val-required="Date*" id="bdate" name="Date"  aria-describedby="Date-error" aria-invalid="false"><option value="">Date</option>
                                                ...
                                                <p id="errbdatemsg" style="display:none;color:red"></p>
                                        </div>
                                        <div class="col-md-4 col-xs-4">
                                            <select class="kundli_match_select valid" data-val="true" data-val-required="Month*" id="bmonth" name="Month"><option value="">Month</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                                <option value="4">4</option>
                                                ...
                                                <p id="errbmonthmsg" style="display:none;color:red"></p>
                                        </div>
                                        <div class="col-md-4 col-xs-4">
                                            <select class="kundli_match_select valid" data-val="true" data-val-required="Year*" id="byear" name="Year" ><option value="">Year</option>
                                                ...
                                                <p id="errbyearmsg" style="display:none;color:red"></p>
                                        </div>
                                </div>
                                <div class="birthtime mtb">
                                    <label class="col-md-12">Birth Time</label>
                                    <div class="col-md-4 col-xs-4">
                                        <select class="kundli_match_select valid" data-val-required="hour required" data-val="true" data-val-range="Hour*" data-val-range-max="12" data-val-range-min="1" id="bhh" name="Kund_F_BirthPlace_Hour" aria-describedby="Kund_F_BirthPlace_Hour-error" aria-invalid="false">
                                            <option value="">Hour</option>
                                            <option>1</option><option>2</option><option>3</option><option>4</option><option>5</option>
                                            <option>6</option><option>7</option><option>8</option><option>9</option><option>10</option>
                                            <option>11</option><option>12</option>
                                        </select>
                                        <p id="errbhhmsg" style="display:none;color:red"></p>
                                    </div>
                                    <div class="col-md-4 col-xs-4">
                                        <select class="kundli_match_select valid" placeholder="houes" data-val="true" data-val-range="Minute*" data-val-range-max="59" data-val-range-min="0" id="bmm" name="Kund_F_BirthPlace_Minute" aria-describedby="Kund_F_BirthPlace_Minute-error" aria-invalid="false">
                                        ...
                                        <p id="errbmmmsg" style="display:none;color:red"></p>
                                    </div>
                                    <div class="col-md-4 col-xs-4">
                                        <select class="kundli_match_select valid" id="bampm" name="Kund_F_BirthPlace_AM" aria-invalid="false">
                                ...
                                <div class="birthplace mtb">
                                    ...
                                    <div class="col-md-12">
                                        <input class="kundli_form_input" placeholder="Enter Place Of Birth" autocomplete="off" type="text" data-val="true" data-val-required="Birth place*" id="bbirth" name="Kund_BirthPlace" value="">
                                        <p id="errbbirthmsg" style="display:none;color:red"></p>
                            ...
                            <form >
                                <div class="mtb name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p id="errgnamemsg" style="display:none;color:red"></p>
                                        </div>
                                        <!-- <div class="col-md-4 col-xs-4">
                                                <div class="form-group">
                                                    <label>Gender</label>
                                ...
                                <div class="dob mtb">
                                        <label class="col-md-12">Date of Birth</label>
                                        <div class="col-md-4 col-xs-4">
                                            <select class="kundli_match_select valid" data-val="true" data-val-required="Date*" id="gdate" name="Date"  aria-describedby="Date-error" aria-invalid="false"><option value="">Date</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                                <option value="4">4</option>
                                                ...
                                                <p id="errgdatemsg" style="display:none;color:red"></p>
                                        </div>
                                        <div class="col-md-4 col-xs-4">
                                            <select class="kundli_match_select valid" data-val="true" data-val-required="Month*" id="gmonth" name="Month"><option value="">Month</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                                <option value="4">4</option>
                                                ...
                                                <p id="errgmonthmsg" style="display:none;color:red"></p>
                                        </div>
                                        <div class="col-md-4 col-xs-4">
                                            <select class="kundli_match_select valid" data-val="true" data-val-required="Year*" id="gyear" name="Year" ><option value="">Year</option>
                                                <option value="1945">1945</option>
                                                <option value="1946">1946</option>
                                                <option value="1947">1947</option>
                                                <option value="1948">1948</option>
                                                ...
                                                <p id="errgyearmsg" style="display:none;color:red"></p>
                                        </div>
                                </div>
                                <div class="birthtime mtb">
                                    <label class="col-md-12">Birth Time</label>
                                    <div class="col-md-4 col-xs-4">
                                        <select class="kundli_match_select valid" data-val-required="hour required" data-val="true" data-val-range="Hour*" data-val-range-max="12" data-val-range-min="1" id="ghh" name="Kund_F_BirthPlace_Hour" aria-describedby="Kund_F_BirthPlace_Hour-error" aria-invalid="false">
                                            <option value="">Hour</option>
                                            <option>1</option><option>2</option><option>3</option><option>4</option><option>5</option>
                                            <option>6</option><option>7</option><option>8</option><option>9</option><option>10</option>
                                            <option>11</option><option>12</option>
                                            <p id="errghhmsg" style="display:none;color:red"></p>
                                    
                                        </select>
                                    </div>
                                    <div class="col-md-4 col-xs-4">
                                        <select class="kundli_match_select valid" placeholder="houes" data-val="true" data-val-range="Minute*" data-val-range-max="59" data-val-range-min="0" id="gmm" name="Kund_F_BirthPlace_Minute" aria-describedby="Kund_F_BirthPlace_Minute-error" aria-invalid="false">
                                            <option value="">Minute</option>
                                            <option>00</option><option>01</option><option>02</option><option>03</option><option>04</option>
                                            <option>05</option><option>06</option><option>07</option><option>08</option><option>09</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option>
                                            <option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option><option>25</option><option>26</option><option>27</option><option>28</option>
                                            ...
                                            <option>41</option><option>42</option><option>43</option><option>44</option><option>45</option><option>46</option><option>47</option><option>48</option><option>49</option><option>50</option><option>51</option><option>52</option>
                                            <option>53</option><option>54</option><option>55</option><option>56</option><option>57</option><option>58</option><option>59</option>
                                            <p id="errgmmmsg" style="display:none;color:red"></p>
                                ...
                                <div class="birthplace mtb">
                                    <label class="col-md-12">Birth Place</label>
                                    <div class="col-md-12">
                                        <input class="kundli_form_input" placeholder="Enter Place Of Birth" autocomplete="off" type="text" data-val="true" data-val-required="Birth place*" id="gbirth" name="Kund_BirthPlace" value="">
                                        <p id="errgbirthmsg" style="display:none;color:red"></p>
                        ...
                        <div class="col-md-12 text-center">
                                        <a class="btn btn-default btn-rounded btn-shadowed" id = "getmatching" href="#">Match Your Kundali now</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row m-zero">
            <div class="getmarried flexprop">
                ...
                <div class="col-md-6  col-sm-6">
                   ...
                   <a href="<?php echo base_url(); ?>talk-to-astrologers/" class="btn btn-default btn-rounded btn-shadowed call-now milan-call">Call Now</a>
                </div>
             </div>
        </div>
    </div>
        ...
        <div class="row m-zero">
            <div class="col-md-7 form-field">
                <div class="love_arrange flexprop pink">
                   ...
                   <a class="btn btn-default btn-rounded btn-shadowed" href="<?php echo base_url(); ?>talk-to-astrologers/">Talk Now</a>
                </div>
             </div>
        </div>
    </div>
...
<script>
   ...
   $("#getmatching").click(function () {
    ...
    //    }
       if(bbirth==""){
           $('#errbbirthmsg').css('display', 'block');
           $('#errbbirthmsg').text('Please enter your Birth');
           return false;
       }
        var bb =  /^[a-zA-Z'-]+$/;
    ...
    //    }
       ...
       if(gbirth==""){
           $('#errgbirthmsg').css('display', 'block');
           $('#errgbirthmsg').text('Please enter your Birth');
           return false;
       }
        var gg =  /^[a-zA-Z'-]+$/;
