               ...
               <div class="overlay-chat">
                  <div class="chat-text1">
                     <p id="txtmsgchat">Please wait, <span> <?php echo $astro[0]->name;?> </span> will accept your Chat request in <label class="inner-clock">
                        <time id="acceptTimeLeft" val="">02:00</time>
    ...
    $.ajax({
         ...
         success: function (callDetails) {
          ...
          // Chat notification API integration
                           ...
                           // Credit API commented 
                           $.ajax({
                              url: "https://www.onegodmed.com/credit",
                              method: "POST",
                              data: {userid: '<?php echo $order_chat[0]->astrologer_id;?>'}, 
