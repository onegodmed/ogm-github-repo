...
define('PAYTM_MERCHANT_KEY', 'XVDbhpIALv5E_Kb%'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'mjhhqg49725791992291'); //Change this constant's value with MID (Merchant ID) received from Paytm.
