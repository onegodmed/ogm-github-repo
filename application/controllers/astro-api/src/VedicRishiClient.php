...
public function matchHoroscope(array $maleBirthData, array $femaleBirthData)
    {
        //TODO:  needs to validate male and female birth data against expected keys
        //$this->dataSanityCheck($maleBirthData);
        //$this->dataSanityCheck($femaleBirthData);
 ...
 public function getMatchMakingPercentage(array $maleBirthData, array $femaleBirthData)
    {
        //TODO:  needs to validate male and female birth data against expected keys
        //$this->dataSanityCheck($maleBirthData);
        //$this->dataSanityCheck($femaleBirthData);
        $resourceName = 'match_percentage';
        $data = $this->packageMatchMakingData($maleBirthData, $femaleBirthData);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function getpPartnerReport(array $maleBirthData, array $femaleBirthData)
    {
        //TODO:  needs to validate male and female birth data against expected keys
        //$this->dataSanityCheck($maleBirthData);
        //$this->dataSanityCheck($femaleBirthData);
        $resourceName = 'partner_report';
        $data = $this->packageMatchMakingData($maleBirthData, $femaleBirthData);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
 ...
 public function getNumeroDaily($date, $month, $year, $name)
    ...
    public function getWeeklyPrediction($zodiacSign, $timezone)
    {
 ...
 public function getpreviousNakshatraPrediction($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
        $resourceName = 'daily_nakshatra_prediction/previous';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    
    public function getnextNakshatraPrediction($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getbiorhythmdetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
...
public function getPlanetsChart($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone)
    {
    ...
    public function getChartById($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $planetColor, $signColor, $lineColor, $chartId)
    {
        $resourceName = 'horo_chart_image/'.$chartId;
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $planetColor, $signColor, $lineColor);
        $response = getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
