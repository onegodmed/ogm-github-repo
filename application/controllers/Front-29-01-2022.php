...
// ------------------------------     pay With Bank in sub category section   ------------------------
    ...
    $data2 = array(
        ...
        $postdata = file_get_contents($path);
        $userData = json_decode($postdata, 1);
        if ($userData['refno'] != '' || $userData['refno'] == ''){  // TO DO
            ...
            if (($eventtype == "missed") || ($eventtype == "answered") || ($eventtype == "CustomerHangup")) { // TO DO
...
sleep(15);
    ...
    public function send(){
        ...
        // if($count < 3){
        //     $uid = @$this->input->post('userid');
        //     // $uid = "3756"; // Mangesh/ Astrologer user id
        //     $count++;
        // }
        ...
        $notifData = [
            'title' => "Chat start notification!",
            'body' => "Customer has started the chat...!!!!",
    ...
    public function credit(){
        ...
        // Add notification content to a variable for easy reference
        $notifData = [
            'title' => "Chat end notification!",
            'body' => "Customer has ended the chat...!!!!",
            'sound' => "notificationsound.mp3" //notificationsound.wav
        // 'click_action' => "android.intent.action.MAIN"
        ];
        ...
        curl_close ( $ch );
         ...
         $resultData['status'] = true;
         $resultData['data'] = $result;
         $resultData['message'] = "Chat end request notification .. !!!.";
         $httpCode = 200; 
