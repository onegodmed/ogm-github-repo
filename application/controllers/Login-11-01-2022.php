...
echo json_encode(array("status"=>0,"message"=>"Incorrect OTP"));
        ...
        'logged_in' => TRUE
          ...
          if($this->input->post('remember_me')  == 'yes'){
            $this->input->set_cookie(array('name'=>'username', 'value'=>$this->input->post('username'), 'expire'=>100000));    
        $this->input->set_cookie(array('name'=>'password', 'value'=>$this->input->post('password'), 'expire'=>100000));
